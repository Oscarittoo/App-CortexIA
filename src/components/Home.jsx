    ...
    <div className="home-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-description">
            CORTEXA transcrit, résume et extrait automatiquement les tâches de vos réunions en temps réel.
        ...
        <div className="process-steps">
          <div className="process-step">
            ...
            <div className="step-content">
              <h3>Participez</h3>
              <p>Connectez votre calendrier. CORTEXA rejoint automatiquement vos appels Zoom, Teams ou Meet.</p>
            </div>
          </div>
      ...
      <section className="cta-section">
        <div className="cta-content">
          ...
          <p>Rejoignez des milliers d'équipes qui économisent déjà du temps avec CORTEXA</p>
